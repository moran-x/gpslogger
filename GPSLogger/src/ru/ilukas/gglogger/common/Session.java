...
package ru.ilukas.gglogger.common;
...
public class Session extends Application
{
    ...
    private static double SatellitesInfo[][];
    ...
    public static void setSatellitesInfo(double SatellitesInfo[][])
    {
    	Session.SatellitesInfo = SatellitesInfo;
    	/*for (int i = 0; i < SatellitesInfo.length; i++) {
			for (int j = 0; j < SatellitesInfo[i].length; j++) {
				Utilities.LogDebug("SESSION "+Double.toString(SatellitesInfo[i][j]));
				//Log.d("!!!", Double.toString(SatellitesInfo[i][j]));
				
			}
		}*/
    }
    
    public static double[][] getSatelliteslInfo()
    {
    	return SatellitesInfo;
    }
    /*public static void setGPSStatus(GpsStatus gpsstatus) {
    	Session.gpsstatus = gpsstatus;
	}
  ...
  public static void setArmedForNextPoint(boolean armedForNextPoint)
  {
    ...
    public static void setLatLonList(LatLng loc)
    {
    	pathPoints.add(loc);
    }
